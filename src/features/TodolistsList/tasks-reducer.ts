...
const slice = createSlice({
    ...
    extraReducers: (builder: ActionReducerMapBuilder<TasksStateType>) => {
        builder.addCase(addTodolistAC, (state: TasksStateType, action: any) => {
            state[action.payload.todolistId.id] = [];
        });
        builder.addCase(removeTodolistAC, (state: TasksStateType, action: any) => {
            delete state[action.payload.id];
        });
        builder.addCase(setTodolistsAC, (state: TasksStateType, action: any) => {
            action.payload.todolistId.forEach((tl:any) => {
                state[tl.id] = []
        })
    });
}})
